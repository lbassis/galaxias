...
Para testar a versão funcional utilizando a máquina virtual fornecida, basta executar os códigos
presentes em \textit{home/galaxias/funcional/definitions.R} e
\textit{home/galaxias/funcional/graphics.R} respectivamente. O resultado atualmente é armazenado
no arquivo \textit{home/result.gif}.

Para testar a versão orientada a objeto, [COMPLETAR AQUI AAAAA]
