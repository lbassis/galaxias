...
% título
\title{Modelos de Linguagens de Programação - Galáxias em R}
...
\begin{figure}[htb]
    ...
    \fbox{
        \includegraphics[width=20cm,height=10cm,keepaspectratio]{images/barneshut.png}
    }
...
\begin{figure}[htb]
    ...
    \fbox{
        \includegraphics[width=20cm,height=10cm,,keepaspectratio]{images/quadtree.jpeg}
    }
...
\begin{figure}[htb]
    ...
    \fbox{
        \includegraphics[width=20cm,height=10cm,,keepaspectratio]{images/particulas.jpg}
    }
...
\begin{figure}[htb]
    ...
    \fbox{
        \includegraphics[width=20cm,height=10cm,keepaspectratio]{images/grafico.png}
    }
    \label{fig:grafico}
\end{figure}
